...
import org.npp.model.rate.RateTable;
...
/**
 * Paginated list of RateTable
 */

@Schema(name = "RateTableList", description = "Paginated list of RateTable")

public class RateTableList {
  ...
  @Valid
  private List<@Valid RateTable> data;
   ...
   */
  public RateTableList(Integer referenceInstant, Integer offset, Integer pageSize, Integer total) {
  ...
  public RateTableList referenceInstant(Integer referenceInstant) {
    this.referenceInstant = referenceInstant;
    return this;
  }
  ...
  */
  ...
  public RateTableList offset(Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  */
  ...
  public RateTableList pageSize(Integer pageSize) {
    this.pageSize = pageSize;
    return this;
  }
  ...
  */
  ...
  public RateTableList total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public RateTableList data(List<@Valid RateTable> data) {
    this.data = data;
    return this;
  }

  public RateTableList addDataItem(RateTable dataItem) {
    if (this.data == null) {
  ...
  */
  @Valid 
  @Schema(name = "data", description = "List of RateTables", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("data")
  public List<@Valid RateTable> getData() {
    return data;
  }

  public void setData(List<@Valid RateTable> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    RateTableList rateTableList = (RateTableList) o;
    return Objects.equals(this.referenceInstant, rateTableList.referenceInstant) &&
        Objects.equals(this.offset, rateTableList.offset) &&
        Objects.equals(this.pageSize, rateTableList.pageSize) &&
        Objects.equals(this.total, rateTableList.total) &&
        Objects.equals(this.data, rateTableList.data);
  }
