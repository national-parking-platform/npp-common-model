...
/**
 * Interface for the creation of an AssignedRight
 */

@Schema(name = "CreateAssignedRight", description = "Interface for the creation of an AssignedRight")


public class CreateAssignedRight {
  ...
  public CreateAssignedRight metaType(MetaTypeEnum metaType) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    CreateAssignedRight createAssignedRight = (CreateAssignedRight) o;
    return Objects.equals(this.metaType, createAssignedRight.metaType);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAssignedRight {\n");
