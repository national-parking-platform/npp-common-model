...
public class DeletedReference {
  ...
  */
  @NotNull 
  @Schema(name = "id", description = "The unique identifier within the given class.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("id")
  public String getId() {
    return id;
  }
  ...
  */
  ...
  @Schema(name = "className", description = "The class name of the referenced object in PascalCase.", requiredMode = Schema.RequiredMode.REQUIRED)
