...
public class UserDefinedCodeList {
  ...
  private String includeNilReasonType;
   ...
   */
  public UserDefinedCodeList(VersionedReference creator, String includeNilReasonType, String locator, List<@Valid UserDefinedCodeListEntry> userDefinedCodeListEntries) {
  ...
  */
  ...
  public UserDefinedCodeList includeNilReasonType(String includeNilReasonType) {
    this.includeNilReasonType = includeNilReasonType;
    return this;
  }

  /**
   * Boolean: [TRUE] indicates the NilReasonType list shall be included in this user defined code list.
   * @return includeNilReasonType
  */
  @NotNull 
  @Schema(name = "includeNilReasonType", description = "Boolean: [TRUE] indicates the NilReasonType list shall be included in this user defined code list.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("includeNilReasonType")
  public String getIncludeNilReasonType() {
    return includeNilReasonType;
  }

  public void setIncludeNilReasonType(String includeNilReasonType) {
    this.includeNilReasonType = includeNilReasonType;
  }
