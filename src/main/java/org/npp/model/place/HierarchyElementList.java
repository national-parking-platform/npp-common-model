...
/**
 * Paginated list of HierarchyElements
 */

@Schema(name = "HierarchyElementList", description = "Paginated list of HierarchyElements")

public class HierarchyElementList {
  ...
  @Valid
  private List<@Valid HierarchyElement> data;

  public HierarchyElementList() {
    super();
  }
   ...
   */
  public HierarchyElementList(Integer referenceInstant, Integer offset, Integer pageSize, Integer total) {
  ...
  public HierarchyElementList referenceInstant(Integer referenceInstant) {
    this.referenceInstant = referenceInstant;
    return this;
  }
  ...
  */
  ...
  public HierarchyElementList offset(Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  */
  ...
  public HierarchyElementList pageSize(Integer pageSize) {
    this.pageSize = pageSize;
    return this;
  }
  ...
  */
  ...
  public HierarchyElementList total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public HierarchyElementList data(List<@Valid HierarchyElement> data) {
    this.data = data;
    return this;
  }

  public HierarchyElementList addDataItem(HierarchyElement dataItem) {
    if (this.data == null) {
  ...
  /**
   * List of HierarchyElements
   * @return data
  */
  @Valid 
  @Schema(name = "data", description = "List of HierarchyElements", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("data")
  public List<@Valid HierarchyElement> getData() {
    return data;
  }

  public void setData(List<@Valid HierarchyElement> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    HierarchyElementList hierarchyElementList = (HierarchyElementList) o;
    return Objects.equals(this.referenceInstant, hierarchyElementList.referenceInstant) &&
        Objects.equals(this.offset, hierarchyElementList.offset) &&
        Objects.equals(this.pageSize, hierarchyElementList.pageSize) &&
        Objects.equals(this.total, hierarchyElementList.total) &&
        Objects.equals(this.data, hierarchyElementList.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class HierarchyElementList {\n");
