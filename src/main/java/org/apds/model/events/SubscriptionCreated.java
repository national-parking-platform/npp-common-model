...
public class SubscriptionCreated implements Event<EventSubscription>, Serializable {
    ...
    public static SubscriptionCreated withPayload( EventSubscription payload) {
        SubscriptionCreated event = new SubscriptionCreated();
        event.setPayload( payload);
        return event;
    }

    public SubscriptionCreated from( String origin) {
        this.origin = origin;
        return this;
    }
